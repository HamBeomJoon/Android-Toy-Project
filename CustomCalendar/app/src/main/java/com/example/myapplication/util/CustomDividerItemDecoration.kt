...
class CustomDividerItemDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    private fun drawHorizontal(c: Canvas, parent: RecyclerView) {
        ...
        horizontalDivider?.setBounds(
            ...
            parent.paddingTop,
            right,
            parent.paddingTop + (horizontalDivider?.intrinsicHeight ?: 0)
        )
        horizontalDivider?.draw(c)
        ...
        horizontalDivider?.setBounds(
            left,
            parent.height - (horizontalDivider?.intrinsicHeight ?: 0),
            right,
            parent.height
        )
        horizontalDivider?.draw(c)
    ...
    private fun drawVertical(c: Canvas, parent: RecyclerView) {
        ...
        verticalDivider?.setBounds(
            parent.paddingLeft,
            top,
            parent.paddingLeft + (verticalDivider?.intrinsicWidth ?: 0),
            bottom
        )
        verticalDivider?.draw(c)
        ...
        // 맨 오른쪽 선 추가
        verticalDivider?.setBounds(
            parent.width - (verticalDivider?.intrinsicWidth ?: 0),
            top,
            parent.width,
            bottom
        )
