...
import com.example.myapplication.databinding.ItemDayDateBinding
...
class DayViewPagerAdapter(
    ...
    inner class ViewHolder(val binding: ItemDayDateBinding) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.timeSlotsRecyclerView.layoutManager =
            LinearLayoutManager(holder.itemView.context, LinearLayoutManager.VERTICAL, false)
        holder.binding.timeSlotsRecyclerView.addItemDecoration(
